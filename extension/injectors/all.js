...
scriptElemBadges.dataset.logoUrl = chrome.runtime.getURL('/img/LogoCoScratch.svg');
...
scriptElemModal.dataset.logoUrl = chrome.runtime.getURL('/img/LogoCoScratch.svg');
